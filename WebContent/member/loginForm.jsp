	...
	<div id="lStatus">
		<ul>
			<li><label for="cid">아이디</label> <input type="email" name="cid"
				id="cid" size="20" maxlength="50" placeholder="abc123@naver.com"
				autofocus="autofocus"> <label for="cpasswd">비밀번호</label> <input
				type="password" name="cpasswd" id="cpasswd" size="20" maxlength="16"
